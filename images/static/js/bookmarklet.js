...
(function(){
    ...
    function bookmarklet(msg) {
        ...
        css.attr({
            rel: 'stylesheet',
            type: 'text/css',
            href: static_url+'css/bookmarklet.css?r='+Math.floor.random()*99999999999999999999)
            });
        ...
        (function(){
            ...
            if(typeof window.jQuery == 'undefined'){
                if(--attempts > 0){
                    ...
                    // Too much attempts to load, sen error
...
jQuery.each(jQuery('img[src$="jpg"]'), function(index, image) {
    if (jQuery(image).width() >= min_width && jQuery(image).height() >= min_height)
    {
        ...
        jQuery('#bookmarklet .images').append('<a href="#"><img src="src="'+ image_url +'"/></a>');
    }
    });
